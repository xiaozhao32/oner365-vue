<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="Type" align="center" prop="type" width="140">
        <template slot-scope="scope">
          <el-tag type="success">{{ scope.row.type }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="Durable" align="center" prop="durable" width="130" />
      <el-table-column label="Internal" align="center" prop="internal" width="130" />
      <el-table-column label="Delete" align="center" prop="auto_delete" width="130" />
...
export default {
  ...
  methods: {
    getList() {
      this.loading = true;
      rabbitmqList('exchanges', this.queryParams).then(response => {
